// constants.js
export const cblTheme = {
  cblPrimary: '#667eea',
  cblEngage: '#ff6b6b',
  cblInvestigate: '#4ecdc4', 
  cblAct: '#45b7d1'
};
...
export const NUDGE_CATEGORIES = {
  ...
  // Investigate com 4 categorias específicas
  Investigate: {
    'Guiding Questions': [
      {
        id: 'inv_gq_1',
      ...
      {
        id: 'inv_gq_3',
        title: 'Você tem perguntas suficientes sobre o que está por trás (por que, e se, como assim, etc.)?',
      ...
      {
        id: 'inv_gq_12',
        title: 'Compartilhe seu desafio com outro grupo e peça que eles façam perguntas',
      ...
      {
        id: 'inv_gq_14',
        title: 'Faça o máximo de perguntas que puder em 30 segundos — vamos lá!',
    ...
    'Guiding Activities': [
      {
        id: 'inv_ga_1',
        title: 'Quem sabe as respostas para suas perguntas orientadoras?',
    ...
    'Research Synthesis': [
      ...
      {
        id: 'inv_rs_9',
        title: 'Não faça engenharia reversa. Mantenha-se fiel à sua investigação',
      ...
      {
        id: 'inv_rs_11',
        title: 'Releia todas as suas conclusões a partir das perguntas orientadoras',
  ...
  // Act com 3 categorias específicas
  Act: {
...
// Estrutura padrão para novos projetos CBL - ATUALIZADA
export const defaultPhaseData = {
  Engage: {
    bigIdea: '',
    essentialQuestion: '',
    challenge: '', // Novo campo adicionado
    checklist: [
      { id: 1, text: 'Definir Big Idea', done: false },
      { id: 2, text: 'Formular Essential Question', done: false },
      { id: 3, text: 'Identificar Challenges', done: false }
    ],
    completed: false
  },
  Investigate: {
    guidingQuestions: [
      'O que sabemos sobre esse problema?',
      'Quais são as causas principais?',
      'Quem mais está trabalhando nisto?'
    ],
    answers: [],
    activities: [], // Estrutura para atividades
    resources: [], // Estrutura para recursos
    synthesis: { // Estrutura para síntese
      mainFindings: '',
      patterns: '',
      gaps: ''
    },
    checklist: [
      { id: 1, text: 'Pesquisar fontes confiáveis', done: false },
      { id: 2, text: 'Responder perguntas-guia', done: false },
      { id: 3, text: 'Realizar atividades práticas', done: false },
      { id: 4, text: 'Sintetizar descobertas', done: false }
    ],
    completed: false
  },
  Act: {
    // ESTRUTURAS ORGANIZADAS POR MANAGERS
    solution: { // Para SolutionManager
      description: '',
      functionalities: '',
      differentiation: '',
      technology: ''
    },
    implementation: { // Para ImplementationManager  
      overview: '',
      stakeholders: '',
      risks: '',
      steps: []
    },
    evaluation: { // Para EvaluationManager
      objectives: '',
      methodology: '',
      lessonsLearned: '',
      metrics: []
    },
    prototypes: [], // Para PrototypeManager
    checklist: [
      { id: 1, text: 'Descrever solução detalhadamente', done: false },
      { id: 2, text: 'Criar protótipo funcional', done: false },
      { id: 3, text: 'Definir plano de implementação', done: false },
      { id: 4, text: 'Estabelecer critérios de avaliação', done: false },
      { id: 5, text: 'Testar solução com usuários', done: false }
    ],
    completed: false
  }
};